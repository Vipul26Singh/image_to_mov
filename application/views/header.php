...
<head>
  ...
  <title><?php echo lang('company_name');?></title>
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="stylesheet" href="<?= base_url("assets/admin") ?>/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?= base_url("assets/admin") ?>/dist/css/sweetalert.css">
  <link rel="stylesheet" href="<?= base_url("assets/admin") ?>/dist/css/dropzone.min.css">
